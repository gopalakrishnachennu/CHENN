...
export type CachedJD = { promptSnapshot?: import('./workflow-prompts').WorkflowPrompt; jdHash: string; sourceHash?: string; analysisVersion: string; createdAt: string; engine: 'rules' | 'openai'; model?: string; usage?: import('./ai-client').AIUsage; jdProfile: JDProfile; intelligence: JDAnalysis; requirements: StructuredJobRequirements };
